...
class CarNavigationNode(Node):
    ...
    def __init__(self):
        ...
        initial_pose.pose.pose.position.x = 3735.11401
        initial_pose.pose.pose.position.y = 73726.984375
                
        initial_pose.pose.pose.orientation.x = 0.0
        initial_pose.pose.pose.orientation.y = 0.0
        initial_pose.pose.pose.orientation.z = -0.97247183
        initial_pose.pose.pose.orientation.w = 0.23302044224046514
        time.sleep(5)
        ...
        self.goal_poses.append({'x': 3730.852783, 'y': 73728.2734, 'xx': 0.0,'yy': 0.0,'zz': 0.24175542,'ww':0.97337})
        self.goal_poses.append({'x': 3891.53955, 'y': 73813.21875, 'xx': 0.0,'yy': 0.0,'zz': -0.5063933,'ww':0.862302})
        self.goal_poses.append({'x': 3660.8562011, 'y': 73749.60156, 'xx': 0.0,'yy': 0.0,'zz': 0.45056657,'ww':0.89274283})
