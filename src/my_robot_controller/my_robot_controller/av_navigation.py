...
class CarNavigationNode(Node): 
    ...
    def setup_initial_pose(self): 
        ...
        initial_pose.pose.pose.position.x = 3742.304 
        initial_pose.pose.pose.position.y = 73730.554 
        initial_pose.pose.pose.orientation.z = -0.96 
        initial_pose.pose.pose.orientation.w = 0.27 
        time.sleep(10)
        self.initial_pose_publisher.publish(initial_pose) 
        
    def setup_goals(self): 
        self.goal_poses = [ 
        {'x': 3722.05, 'y': 73684.67, 'xx': 0.0, 'yy': 0.0, 'zz': -0.52, 'w': 0.85}, 
        {'x': 3777.85, 'y': 73715.88, 'xx': 0.0, 'yy': 0.0, 'zz': 0.83, 'w': 0.54},
        {'x': 3774.52, 'y': 73722.18, 'xx': 0.0, 'yy': 0.0, 'zz': 0.83, 'w': 0.55} 
        ] 
        time.sleep(5)
        self.publish_goal() 
